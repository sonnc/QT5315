...
public class GiangVienHuongDan  implements java.io.Serializable {
    ...
    public GiangVienHuongDan(CongTy congTy, Login login, int maCongTy, String email, String hoTen, String chucvu, String dienThoai, String avatar, String diaChi, String linhVucHoatDong, String duAn, Set deTais) {
       this.congTy = congTy;
       this.login = login;
