...
public class GiangVienPhuTrach  implements java.io.Serializable {
    ...
    public GiangVienPhuTrach(Login login, String email, String hoTen, String diaChi, String dienThoai, String khoaVien, String boMon, String congTrinhNghienCuu, String sachXuatBan, String monGiangDay, String khac, String avatar) {
       this.login = login;
       this.email = email;
       this.hoTen = hoTen;
       this.diaChi = diaChi;
