                                                    ...
                                                    <article style="margin-bottom: 0px; padding-bottom: 0px">
                                                        <div class="post-image" style="margin: 0px">
                                                            <div class="post-heading">
                                                                ...
                                                                <div id="background-popup<s:property value="maCongTy"/>" style="z-index:85; position: fixed; display:none; height:100%; width:100%; background:#000; top:0px; left:0px;"></div>

                                                            </div>
                                                        </div>

                                                        <div class="max-lines" style="margin: 0; font-size: 13px"><strong>Mô tả công ty: </strong><s:property value="moTa" escapeHtml="false"/> </div>
                                                        <div class="max-lines" style="margin: 0; font-size: 13px"><strong>Lĩnh vực hoạt động: </strong><s:property value="linhVucHoatDong" escapeHtml="false"/></div>
                                                        <ul class="meta-post" style="font-size: 13px">
                                                            <li style="padding-right: 0px"><i class="fa fa-location-arrow"></i><strong>Địa chỉ: </strong><s:property value="diaChi"/></li>
                                                            <li style="padding-right: 0px"><i class="fa fa-phone"></i><strong>Điện thoại: </strong><s:property value="dienThoai"/></li>
                                                        </ul>
