                        ...
                        <div class="col-lg-8">
                            ...
                            <s:iterator value="lstSVI">
                                <div>
                                    ...
                                    <p><s:property value="ngoaiNgu"/></p>
                                </div>
                                <div>
                                    <label>Kỹ năng lập trình</label>
                                    <p><s:property value="kyNangLt"/></p>
                                </div>
                                <div>
                                    <label>Kỹ năng mềm/ kỹ năng khác</label>
                                    <p><s:property value="kyNangKhac"/></p>
                                </div>
                                <div>
                                    <label>Mục tiêu</label>
                                    <p><s:property value="mucTieu"/></p>
                                </div>
                                <div>
                                    <label>Hoạt động</label>
                                    <p><s:property value="hoatDong"/></p>
                                </div>
                                <div>
                                    <label>Giải thưởng</label>
                                    <p><s:property value="giaiThuong"/></p>
                                </div>
                                <div>
                                    <label>Sở thích</label>
                                    <p><s:property value="soThich"/></p>
                                </div>
                                <div>
                                    <label>Dự án</label>
                                    <p><s:property value="duAn"/></p>
                                </div>
                            </s:iterator>
